...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-32 bg-[#050505] overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row gap-24 items-start">
          ...
          <div className="lg:w-5/12 sticky top-32">
            ...
            >
              <span className="text-secondary font-black uppercase tracking-[0.5em] text-[10px] block mb-6 px-6 py-2 bg-secondary/10 rounded-full border border-secondary/20 backdrop-blur-md">
                GET IN TOUCH
              </span>
            </motion.div>
            <div className="relative inline-block perspective-2000">
              <motion.h2
                ...
                className="text-5xl md:text-8xl font-serif font-black text-white leading-[1] mb-10 tracking-tighter preserve-3d"
              >
                Let's Color <br />
                <span className="text-secondary drop-shadow-[0_10px_30px_rgba(249,115,22,0.3)]">Your Vision</span>
              </motion.h2>
            </div>
            <p className="text-gray-400 text-xl mb-16 leading-relaxed font-light tracking-wide italic">
              Ready to architect atmosphere? Contact Sikander Art for a high-fidelity consultation in Karachi. <br />
              <span className="text-white font-bold not-italic">Response within 12 hours.</span>
            </p>

            <div className="space-y-10 mb-16">
              {[
                { icon: Phone, title: "Quantum Line", info: "+92 302 291 10 88", href: "tel: +92 302 291 10 88" },
                { icon: Mail, title: "Neural Link", info: "bilal_azeemlab@gmail.com", href: "mailto:bilal_azeemlab@gmail.com" },
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <h4 className="font-black text-gray-500 uppercase text-[10px] tracking-[0.4em] mb-2">{item.title}</h4>
                    <p className="text-2xl font-black text-white group-hover:text-secondary transition-colors duration-300">{item.info}</p>
                  </div>
                </motion.a>
              ))}
            </div>
            ...
            <motion.div
              ...
              className="rounded-[3.5rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] h-80 w-full border border-white/10 relative group"
            >
              <div className="absolute inset-0 bg-secondary/10 group-hover:bg-transparent transition-colors duration-700 pointer-events-none z-10" />
              <iframe
                ...
                width="100%"
                height="100%"
                className="map-dark-filter border-0"
            ...
            >
              ...
              <div className="relative z-10 preserve-3d">
                <motion.h3
                  ...
                  className="text-4xl md:text-5xl font-black text-white mb-12 uppercase tracking-tighter translate-z-30"
                >
